...
// This program is to estimate pose from 2 pair image rgb_image and depth image
// Input: points in 3d coordinate and points in 2d coordinate
// Output: R t matrix
...
typedef std::vector<Eigen::Vector2d, Eigen::aligned_allocator<Eigen::Vector2d>> vEigenVector2d;
typedef std::vector<Eigen::Vector3d, Eigen::aligned_allocator<Eigen::Vector3d>> vEigenVector3d;

void bundleAdjustmentG2O(
    const vEigenVector3d &points_3d,
    const vEigenVector2d &points_2d,
    const Mat &K,
    Sophus::SE3d &pose);
...
void bundleAdjustmentG2O(
  ...
  // Build graph optimization, first set it g2o
	// Pose is 6, landmark is 3
  	typedef g2o::BlockSolver<g2o::BlockSolverTraits<6, 3>> BlockSolverType;  
  	typedef g2o::LinearSolverDense<BlockSolverType::PoseMatrixType> LinearSolverType; 
	// Gradient method, which can choose from GN, LM, Dogleg
